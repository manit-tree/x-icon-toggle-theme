...
var r = (e, t, i) => t in e ? o(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i;
...
(() => {
    ...
    constructor() {
      ...
      h(this, "update", () => {
        if (this.querySelector("a")) {
          let s = this.getAttribute("width") ?? "24", d = this.getAttribute("height") ?? "24";
          this.style.setProperty("--icon-width", s + "px"), this.style.setProperty("--icon-height", d + "px");
        }
      });
    }
    connectedCallback() {
      if (!this.querySelector("a")) {
        ...
        a.setAttribute("data-role", "toggle-theme"), a.innerHTML = `
          ...
          s.classList.contains("dark") ? (s.classList.remove("dark"), s.classList.add("light")) : (s.classList.remove("light"), s.classList.add("dark"));
        }), this.append(a);
      }
      this.update();
    }
  ...
  customElements.define("x-icon-toggle-theme", e);
})();
